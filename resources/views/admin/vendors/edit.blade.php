            ...
            <div class="row justify-content-md-center justify-content-lg-center">
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                    ...
                    <div class="kt-portlet">
                        {!! Form::open(array('route' => ['vendors.update',$vendor->id],'method'=>'PATCH','class'=>'kt-form kt-form--label-right','files'=>true)) !!}
                        ...
                        <div class="kt-portlet__head form-header">
                         ...
                         <div class="kt-portlet__body">
                             ...
                             <div class="form-group row {{ $errors->has('name') ? 'has-error' : '' }}">
                                 ...
                                 <div class="col-md-6">
                                     {{Form::text('name',$value=old('name',$vendor->name),array('class'=>'form-control','placeholder'=>'Supplier name here','required','autofocus'))}}
                                     @if ($errors->has('name'))
                             ...
                             <div class="form-group row {{ $errors->has('email') ? 'has-error' : '' }}">
                                 ...
                                 <div class="col-md-6">
                                     {{Form::email('email',$value=old('email',$vendor->email),array('class'=>'form-control','placeholder'=>'Supplier email here','required','autofocus'))}}
                                     @if ($errors->has('email'))
                                         <span class="help-block">
                             ...
                             <div class="form-group row {{ $errors->has('mobile') ? 'has-error' : '' }}">
                                 ...
                                 <div class="col-md-6">
                                     {{Form::text('mobile',$value=old('mobile',$vendor->mobile),array('class'=>'form-control','placeholder'=>'Supplier Mobile here','required','autofocus'))}}
                             ...
                             <div class="form-group row {{ $errors->has('balance') ? 'has-error' : '' }}">
                                 ...
                                 <div class="col-md-6">
                                     {{Form::number('balance',$value=old('balance',$vendor->balance),array('min'=>0,'class'=>'form-control','placeholder'=>'00.0','required'=>false,'autofocus'))}}
                             ...
                             <div class="form-group row {{ $errors->has('contact_person') ? 'has-error' : '' }}">
                                 ...
                                 <div class="col-md-6">
                                     {{Form::number('contact_person',$value=old('contact_person',$vendor->contact_person),array('class'=>'form-control','placeholder'=>'','required'=>false,'autofocus'))}}
                             ...
                             <div class="form-group row {{ $errors->has('contact_person_mobile') ? 'has-error' : '' }}">
                                 ...
                                 <div class="col-md-6">
                                     {{Form::number('contact_person_mobile',$value=old('contact_person_mobile',$vendor->contact_person_mobile),array('class'=>'form-control','placeholder'=>'','required'=>false,'autofocus'))}}
                             ...
                             <div class="form-group row">
                                 ...
                                 <div class="col-md-6">
                                     {{Form::textArea('office_address',$value=old('office_address',$vendor->office_address), ['class' => 'form-control','rows'=>'2','placeholder'=>'Office Address '])}}
                             ...
                             <div class="form-group row">
                                 ...
                                 <div class="col-md-6">
                                     {{Form::textArea('warehouse_address',$value=old('warehouse_address',$vendor->warehouse_address), ['class' => 'form-control','rows'=>'2','placeholder'=>'Office Address '])}}
                                 ...
                                 <div class="col-md-2">
                                     {{Form::number('serial_num',$vendor->serial_num, ['min'=>'1','max'=>$max,'class' => 'form-control','required','readonly'=>true])}}
                                     <span> Serial</span>
                                 </div>
                             </div>
