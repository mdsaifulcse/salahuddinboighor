    ...
    <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
        ...
        <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
            ...
            <div class="kt-portlet">
				{!! Form::open(array('route' => ['publishers.update',$publisher->id],'method'=>'PUT','class'=>'kt-form kt-form--label-right','files'=>true)) !!}
										...
										<!--begin::Form-->
											...
											<div class="kt-portlet__body">
												...
												<div class="form-group row">
													...
													<div class="col-9">
                                                    {!! Form::text('name', $value=old('name',$publisher->name), array('placeholder' => 'Name','class' => 'form-control','required'=>true)) !!}
												...
												<div class="form-group row">
													...
													<div class="col-9">
                                                   {!! Form::text('mobile', $value=old('mobile',$publisher->mobile), array('placeholder' => 'Mobile','class' => 'form-control','required'=>false)) !!}
												...
												<div class="form-group row">
													...
													<div class="col-9">
                                                   {!! Form::email('email', $value=old('email',$publisher->email), array('placeholder' => 'Email address','class' => 'form-control','required'=>false)) !!}
												...
												<div class="form-group row">
													...
													<div class="col-9">
														{!! Form::text('address1', $value=old('address1',$publisher->address1), array('placeholder' => 'Address','class' => 'form-control','required'=>false)) !!}
												...
												<div class="form-group row">
													...
													<div class="col-9">
														{!! Form::text('contact', $value=old('contact',$publisher->contact), array('placeholder' => 'Contact number','class' => 'form-control','required'=>false)) !!}
												...
												<div class="form-group row">
													...
													<div class="col-9">
														...
														{!! Form::textArea('bio', $value=old('bio',$publisher->bio), ['rows'=>4,'placeholder' => 'Author Bio','class' => 'form-control textarea','required'=>false]) !!}
                                                   @if ($errors->has('bio'))
                                                    <span class="help-block">
												...
												<div class="form-group row {{ $errors->has('establish') ? 'has-error' : '' }}">
													...
													<div class="col-md-9">
														{{Form::text('establish',$value=old('establish'),array('id'=>'EstablishDate','class'=>'form-control','placeholder'=>'Establish Date','required'=>true))}}
												...
												<div class="form-group row">
													...
													<div class="col-4">
														...
														<label class="slide_upload" for="file">
															...
															@if(isset($publisher->photo) && file_exists($publisher->photo))
																<img id="image_load" src="{{asset($publisher->photo)}}" style="width: 150px;height: 150px;cursor:pointer">
															@else
													...
													<div class="col-md-2">
                                                        <?php $max=$maxSerial+1; ?>
														{{Form::number('serial_num',$publisher->serial_num,['class'=>'form-control','placeholder'=>'Serial Number','max'=>"$max",'min'=>'0','required'=>true])}}
														<small> Serial </small>
													</div>

													<div class="col-md-2">
														{{Form::select('status', $status, $publisher->status, ['class' => 'form-control'])}}
														<small> Status </small>
													</div>
												</div>
...
@section('script')
	...
	<script>
        $(function() {
            ...
            $('#EstablishDate').val("{{date('m/d/Y',strtotime($publisher->establish))}}");
        });
