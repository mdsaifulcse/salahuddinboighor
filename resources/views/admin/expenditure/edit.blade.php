            ...
            <div class="row justify-content-md-center justify-content-lg-center">
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                    <div class="kt-portlet">
                        {!! Form::open(array('route' => ['expenditures.update',$expenditure->id],'method'=>'PUT','class'=>'kt-form kt-form--label-right','files'=>true)) !!}
                        ...
                        <div class="kt-portlet__head form-header">
                         ...
                         <div class="kt-portlet__body">
                             ...
                             <div class="form-group row {{ $errors->has('income_expense_head_id') ? 'has-error' : '' }}">
                                 ...
                                 <div class="col-md-6">
                                     {{Form::select('income_expense_head_id', $incomeExpenseHeads,$expenditure->income_expense_head_id, ['placeholder'=>'Select Expense Head','id'=>'kt_select2_2_1','class' => 'loadSubHead form-control','required'=>true,])}}
                             ...
                             <div class="form-group row {{ $errors->has('income_expense_sub_head_id') ? 'has-error' : '' }}">
                                 ...
                                 <div class="col-md-6" id="subHeadList">
                                     {{Form::select('income_expense_sub_head_id', $subHeadsForHead,$expenditure->income_expense_sub_head_id, ['placeholder'=>'Select Expense Head First','id'=>'kt_select2_2_2','class' => 'form-control','required'=>false,])}}
                             ...
                             <div class="form-group row {{ $errors->has('amount') ? 'has-error' : '' }}">
                                 ...
                                 <div class="col-md-6">
                                     {{Form::number('amount',$value=old('amount',$expenditure->amount),array('min'=>0,'max'=>'9999999999','class'=>'form-control','placeholder'=>'0.0','required'=>true,'autofocus'))}}
                             ...
                             <div class="form-group row {{ $errors->has('expense_method') ? 'has-error' : '' }}">
                                 ...
                                 <div class="col-md-6">
                                     ...
                                     {{Form::select('expense_method', $expenseMethods,$expenditure->expense_method, ['id'=>'expenseMethod','placeholder'=>'Select Expense Account','required'=>true,'class' => 'form-control'])}}
                             ...
                             <?php
                                $display='none';
                                 if ($expenditure->expense_method==\App\Models\Expenditure::BANK)
                                 {
                                     $display='flex';
                                 }
                             ?>

                             <div id="bankAccount" class="form-group row {{ $errors->has('bank_account_id') ? 'has-error' : '' }}" style="display:{{$display}}">

                                 {{Form::label('bank_account_id', 'Account *', array('class' => 'col-md-3 control-label'))}}
                                 <div class="col-md-6">

                                     {{Form::select('bank_account_id', $bankAccounts,$expenditure->bank_account_id, ['id'=>'bankAccountField','placeholder'=>'Select Account','class' => 'form-control'])}}
                             ...
                             <div id="checkNo" class="form-group row {{ $errors->has('check_no') ? 'has-error' : '' }}" style="display:{{$display}}">

                                 {{Form::label('check_no', 'Check Number *', array('class' => 'col-md-3 control-label'))}}
                                 <div class="col-md-6">
                                     {{Form::text('check_no',$value=old('check_no',$expenditure->check_no),array('id'=>'checkNoField','class'=>'form-control','placeholder'=>'Check no.','required'=>false,'autofocus'))}}
                             ...
                             <?php
                             $display='none';
                             if ($expenditure->expense_method==\App\Models\Expenditure::BKASH
                                 || $expenditure->expense_method==\App\Models\Expenditure::NAGAD
                                 || $expenditure->expense_method==\App\Models\Expenditure::ROCKET)
                             {
                                 $display='flex';
                             }
                             ?>

                             <div id="paymentTrx" class="form-group row {{ $errors->has('expense_trxId') ? 'has-error' : '' }}" style="display:{{$display}}">

                                 {{Form::label('expense_trxId', 'Transaction ID *', array('class' => 'col-md-3 control-label'))}}
                                 <div class="col-md-6">
                                     {{Form::text('expense_trxId',$value=old('expense_trxId',$expenditure->expense_trxId),array('id'=>'paymentTrxField','class'=>'form-control','placeholder'=>'Payment TrxID','required'=>false,'autofocus'))}}
                             ...
                             <div class="form-group row {{ $errors->has('note') ? 'has-error' : '' }}">
                                 ...
                                 <div class="col-md-6">
                                     {{Form::textArea('note',$value=old('note',$expenditure->note), ['class' => 'form-control','rows'=>'2','placeholder'=>'Payment Note '])}}
                                     @if ($errors->has('note'))
                                         <span class="help-block">
...
@section('script')
    ...
    <script>
        $(function() {
            ...
            $('#expenseDate').val("{{date('m/d/Y',strtotime($expenditure->expense_date))}}");
        });
