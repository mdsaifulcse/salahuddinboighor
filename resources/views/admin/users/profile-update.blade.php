									...
									{!! Form::open(['url' => 'admin/profile-update','method'=>'POST','class'=>'kt-form kt-form--label-right','files'=>true]) !!}
											...
											<div class="kt-portlet__body">
												...
												<div class="form-group row">
													...
													<div class="col-9">
														{!! Form::text('designation', $value=old('designation',isset($user->profile)?$user->profile->designation:''), array('placeholder' => 'Your Designation Here','class' => 'form-control','required'=>false)) !!}
												...
												<div class="form-group row">
													...
													<div class="col-9">
														{!! Form::textArea('bio', $value=old('bio',isset($user->profile)?$user->profile->bio:''), ['rows'=>4,'placeholder' => 'Your Short Bio ','class' => 'form-control','required'=>false]) !!}
