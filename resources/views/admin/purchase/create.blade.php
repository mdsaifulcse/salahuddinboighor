...
@section('content')
    ...
    border: 1px solid #535353;color: #474747;">
        ...
        <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid" >
            ...
            {!! Form::open(array('route' => 'product-purchases.store','method'=>'POST','class'=>'form-horizontal form-payment','id'=>'orderEdit','files'=>false)) !!}
                                    ...
                                    <div class="box-inner">
                                        ...
                                        <div id="payment-new" style="display: block">
                                            ...
                                            <div class="form-group">
                                                ...
                                                {{Form::text('purchase_no',$value=old('purchase_no',$purchaseNo), ['class' => 'form-control','required'=>true,'readonly'=>true])}}
                                            ...
                                            <div class="form-group ">
                                                ...
                                                {{Form::text('po_ref',$value=old('po_ref'), ['class' => 'form-control','required'=>true])}}
                                            ...
                                            <div class="form-group ">
                                                ...
                                                {{Form::text('purchase_date',$value=old('purchase_date'), ['id'=>'purchaseDate','class' => 'form-control','required'=>true])}}
                                            ...
                                            <div class="form-group ">
                                                ...
                                                {{Form::text('due_date',$value=old('due_date'), ['id'=>'dueDate','class' => 'form-control','required'=>true])}}
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <textarea name="payment_term" rows="2" class="form-control" placeholder="Payment Terms">{{old('payment_term')}}</textarea>
                        ...
                        <section class="section-right">
                            ...
                            <div class="checkout-content confirm-section">
                                <div class="confirm-order">
                                    <button type="submit" class="btn btn-success button confirm-button">Save Purchase</button>
                                </div>
                            </div>
                        </section>
                    </div>
    ...
    <script>
        ...
        $('#addProductToPurchase').on('click',function () {
            ...
            $('#tableLoad').html('<center><img src=" {{asset('images/default/loader.gif')}}"/></center>')
                .load('{{URL::to("admin/add-product-to-purchase-list?")}}'+'product_name='+encodeURI(productName)+'&qty='+productQty+'&cost_price='+costPrice);
        })
