    ...
    <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
        ...
        <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
            ...
            <div class="kt-portlet">
				{!! Form::open(array('route' => 'authors.store','method'=>'POST','class'=>'kt-form kt-form--label-right','files'=>true)) !!}
										<div class="kt-portlet__head form-header">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">
													Create new author by fill up required data
												</h3>
											</div>
										</div>
										...
										<!--begin::Form-->
											...
											<div class="kt-portlet__body">
												...
												<div class="form-group row">
													...
													<div class="col-9">
                                                    {!! Form::text('name_bn', $value=old('name_bn'), array('placeholder' => 'Name Bangla','class' => 'form-control','required'=>true)) !!}
												...
												<div class="form-group row">
													...
													<div class="col-md-2">
														{{Form::select('show_home', $showHome, [], ['class' => 'form-control'])}}
