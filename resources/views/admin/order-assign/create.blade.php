...
@section('content')
    ...
    border: 1px solid #535353;color: #474747;">
        ...
        <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid" >
            ...
            {!! Form::open(array('route' => 'order-assign.store','method'=>'POST','class'=>'form-horizontal form-payment','id'=>'orderEdit','files'=>false)) !!}
                                    ...
                                    <div class="box-inner">
                                        ...
                                        <div id="payment-new">
                                            ...
                                            <div class="form-group">
                                                ...
                                                {{Form::text('order_id_no',$value=old('order_id_no'), ['class' => 'form-control','required'=>true,'placeholder'=>'Enter Order ID'])}}
                                            ...
                                            <div class="form-group company-input">
                                                ...
                                                {!! Form::select('user_id',$deliveryUser,[], ['placeholder' => '--Select One --','class' => 'form-control','required'=>true]) !!}
                                            ...
                                            <div class="form-group">
                                                ...
                                                {{Form::text('assign_no',$value=old('assign_no',$assignNo), ['class' => 'form-control','required'=>true,'readonly'=>true])}}
                                            ...
                                            <div class="form-group ">
                                                ...
                                                {{Form::text('target_delivery_date',$value=old('target_delivery_date'), ['id'=>'adjustmentDate','class' => 'form-control','required'=>true])}}
                                            ...
                                            <div class="form-group ">
                                                ...
                                                {{Form::time('target_delivery_time',$value=old('target_delivery_time'), ['class' => 'form-control','required'=>true])}}
                                            ...
                                            <div class="checkout-content confirm-section">
                                                <div class="confirm-order">
                                                    <button type="submit" class="btn btn-success button confirm-button">Save</button>
                                                </div>
                                            </div>
