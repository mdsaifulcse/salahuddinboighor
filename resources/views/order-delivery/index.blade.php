...
@section('content')
    ...
    <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
        ...
        <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
            ...
            <table id="orderAssignToMeData" class="table table-striped table-bordered table-hover" width="100%">
...
@section('script')
    <script>
        $(function() {
            $('#orderAssignToMeData').DataTable( {
                processing: true,
                serverSide: true,
                "lengthMenu": [[50, 100, 200,500, -1], [50, 100, 200, 500,"All"]],

                ajax: '<?php echo url("order-delivery/order-assign-to-me-data?".'today='.$today.'&this_month='.$thisMonth.'&delivery_status='.$deliveryStatus.'&payment_status='.$paymentStatus) ?>',
                columns: [
